...
${show ? `<section class="fixed top-0 left-0 w-full h-full bg-black bg-opacity-80 z-50"><div class="mx-auto mt-8 z-10 sm:h-[550px] sm:w-[900px] w-[400px] rounded-xl bg-white "><div class="sm:py-8 sm:px-16 flex flex-col "><div class="flex flex-row justify-between font-Montserrat p-3 sm:p-0 sm:text-2xl font-bold text-[#000000B3] sm:mb-5"><div class="sm:w-[20%] ">LEAVE US A MESSAGE</div>
					<button class="text-sm sm:text-5xl text-[#E3211A]">X</button></div>
				<div class="flex flex-row justify-between items-start px-3 sm:px-0 sm:gap-0 gap-4"><div><img src="image 3.png" alt="green mountain" class="sm:w-[68%] rounded-md object-cover h-[300px] sm:h-auto"></div>
...
<footer class="flex flex-col bg-[#E5E5E580] sm:mt-auto "><div class="flex flex-col sm:gap-0 gap-10 sm:flex-row p-8 sm:p-0 sm:justify-between sm:items-center sm:px-16 sm:py-8 font-bold text-[#000000B3]"><div class="sm:w-3/12 w-[50%]"><a href="/" class=""><img src="navbar/Logo.png" alt="Champi Logo" class="sm:w-40 sm:mb-5 "></a>
			<div class="pb-3 text-sm">There are many variations of passages of lorem ipsum available.
			</div>
			<div class="bg-white rounded-full sm:w-[88%] w-[60%] text-slate-400 sm:px-3 sm:py-2 font-light p-1 sm:p-0 text-center sm:text-left"><button>Send Message</button></div></div>
		<div class="flex flex-col sm:flex-row justify-end sm:gap-0 gap-10"><div class="sm:mr-8"><div class="text-lg ">Links</div>
				<div class="flex flex-col text-sm sm:gap-3 gap-1 pt-5"><a href="/">Our Project</a>
					<a href="/abouts">About Us</a>
					<a href="/">Our Service</a>
					<a href="/">Upcoming Events</a>
					<a href="/">Volunteer</a></div></div>
			<div class="sm:w-[32%]"><div class="text-lg">Contact</div>
	...
	<div class="bg-[#1A83E3] flex sm:p-0 p-8"><div class="sm:px-16 sm:py-2 text-white text-base sm:text-xs font-bold">© Copyright 2021 by ABC Food</div></div></footer>`;
});
